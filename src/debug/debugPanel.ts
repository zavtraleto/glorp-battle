...
const RANGES: Record<string, [number, number, number]> = {
  ...
  CHIP_CHARGES_ATTACK: [1, 5, 1],
  CHIP_CHARGES_SUPPORT: [1, 5, 1],
  HAND_COOLDOWN_MIN: [0.5, 8, 0.25],
  HAND_COOLDOWN_MAX: [2, 12, 0.25],
  COOLDOWN_KILL_BONUS: [0, 2, 0.05],
  COOLDOWN_COUNTER_BONUS: [0, 2, 0.05],
  COOLDOWN_COMBO_BONUS: [0, 1, 0.05],
  COOLDOWN_HIT_PENALTY: [0, 3, 0.05],
  LAST_CHARGE_FLIGHT_SCALE: [0.05, 1, 0.05],
